...
const jobCards = {
  ...
  polaris: {
    ...
    inputs: 'An image containing fluorescent spots generated by smFISH or similar assays. For tissue segmentation, input an image containing both a nuclear marker and a membrane/cytoplasm marker. For cell culture segmentation, input an image containing nuclear and/or whole-cell label channels. Pixel size of 0.1 μm recommended.',
